...
const AdminForgotPassword = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Forgot Password | Ilavam Panju Admin</title>
            </Helmet>
                    ...
                    <div className="bg-cotton-white rounded-3xl p-8 shadow-elevated">
                        ...
                        {emailSent ? (
                            <div className="text-center">
                                ...
                                <Link to="/admin/login">
                                    <button className="w-full px-4 py-2 border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-md font-medium flex items-center justify-center">
